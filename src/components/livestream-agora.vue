<template>
  <div class="flex-column flex-justify-start flex-align-center">
    ...
    <div class="flex-row flex-justify-center flex-align-center">
      ...
      <a-input v-model:value="agoraPara.appid" placeholder="应用 ID"></a-input>
      ...
      <span class="ml10" style="white-space: nowrap;">频道:</span>
...
const onUpdateQuality = () => {
  ...
  setLivestreamQuality({
    ...
    if (res.code === 0) {
      message.success('已将清晰度设置为 ' + clarityList[dronePara.claritySelected].label)
    }
  })
}
