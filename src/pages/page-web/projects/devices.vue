<template>
  ...
  <div class="device-table-wrap table flex-display flex-column">
    ...
    <a-modal v-model:visible="deleteTip" width="450px" :closable="false" centered :okButtonProps="{ danger: true }" @ok="unbind">
        <p class="pt10 pl20" style="height: 50px;">将设备从工作空间中删除？</p>
        <template #title>
...
const columns: ColumnProps[] = [
  ...
  { title: '序列号', dataIndex: 'device_sn', width: 100, className: 'titleStyle', ellipsis: true, slots: { customRender: 'sn' } },
  {
    title: '名称',
    dataIndex: 'nickname',
    width: 100,
  ...
  { title: '最后在线', dataIndex: 'login_time', width: 150, sorter: (a: Device, b: Device) => a.login_time.localeCompare(b.login_time), className: 'titleStyle' },
  {
    title: '操作',
    dataIndex: 'actions',
    width: 100,
