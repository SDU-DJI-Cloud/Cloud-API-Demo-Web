<template>
  <div class="demo-project-sidebar-wrapper flex-justify-between">
    ...
    <div class="mb20 flex-display flex-column flex-align-center flex-justify-between">
      <a-tooltip title="回到上一页" placement="right">
...
export default defineComponent({
  ...
  setup () {
    const root = getRoot()
    const options = [
      { key: 0, label: '团队管理', path: '/' + ERouterName.TSA, icon: 'TeamOutlined' },
      ...
      { key: 5, label: '任务库', path: '/' + ERouterName.TASK, icon: 'CalendarOutlined' },
